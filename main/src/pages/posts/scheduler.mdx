...
I've recently became aware of the new Scheduler API. The cool thing about this api is it enables us to be able to yield a long running routine.
As you know, in javascript, if you call a function, the ui will not be able to refresh until that function is done.  This is really important
because we should be prevent the UI to freeze or from being unresponsive to user inputs when developing frontend apps.
...
happening while the long for loop is happening.
